    ...
    details: [
      {
        ...
        image: new URL("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3p_50M9q-yVFTTcFszqJk8HgN-8nbXjXRMk69_MGtTg&s")
      },
      {
        name: "Kitchen",
      ...
      },
      {
        ...
        image: new URL("https://www.thespruce.com/thmb/_VPskZY02V-oej8R-P_FEqSFBls=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/master-bathroom-design-ideas-4129362-hero-d896a889451341dfaa59c5b2beacf02d.jpg")
      }
    ],
    images: [
      {
    ...
    details: [
      {
        name: "Bedroom",
        description: "Comfortable and spacious bed with quality mattress and pillows with Flat-screen TV",
        image: new URL("https://media.istockphoto.com/id/1148202428/photo/luxury-bedroom-interior.jpg?s=612x612&w=0&k=20&c=vZF8d7QvaXqljapoz9PbuQq2Xs9rTAWPi4K1wnKn7Bk=")
      },
      {
        name: "Kitchen",
        description: "Fully equipped kitchenette with appliances such as a stove, microwave, refrigerator, and dishwasher.",
